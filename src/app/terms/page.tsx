...
export default function TermsPage() {
  return (
    <div className="bg-white min-h-screen pt-28 pb-20">
      {/* Banner */}
      <div className="relative py-20 mb-12 bg-cover bg-center overflow-hidden bg-[url('https://images.unsplash.com/photo-1450133064473-71024230f91b?auto=format&fit=crop&q=80&w=1600')]">
